    ...
    <section id="services" className="h-screen w-[90%] mx-auto">
      ...
      <div dir="rtl" className="flex mt-20 w-[75%] mx-auto">
        <div className="border-t border-l border-b basis-1/3 mx-5">
          <div className="pt-10 pb-44 ">
            <div className="w-full">
              <img className="mx-auto w-16" src={g1538} alt="" />
            </div>
            <h3 className="text-nowrap font-cairo font-semibold text-lg text-orange text-center mr-12 mt-6">
              وظائف متاحة
            </h3>
        ...
        <div className="border-t border-l border-b basis-1/3 mx-5">
          <div className="pt-10 pb-44 ">
            <div className="w-full">
              <img className="mx-auto w-16" src={g1539} alt="" />
            </div>
            <h3 className="text-nowrap font-cairo font-semibold text-lg text-orange text-center mt-6">
              آخر الأخبار
            </h3>
        ...
        <div className="border-t border-l border-b basis-1/3 mx-5">
          <div className="pt-10 pb-44 ">
            ...
            <h3 className="text-nowrap font-cairo font-semibold text-lg text-orange text-center mr-20 mt-6">
